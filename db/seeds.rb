...
prereq = PreReq.create([{unit_id: "3", preUnit_id: "1", group: "0"},
						...
						{unit_id: "7", preUnit_id: "4", group: "1"},
						{unit_id: "7", preUnit_id: "3", group: "1"},
						{unit_id: "8", preUnit_id: "2", group: "1"},
						{unit_id: "8", preUnit_id: "5", group: "1"},
						{unit_id: "8", preUnit_id: "3", group: "1"},
						{unit_id: "9", preUnit_id: "7", group: "0"},
						{unit_id: "10", preUnit_id: "3", group: "1"},
						{unit_id: "10", preUnit_id: "4", group: "1"},
						{unit_id: "11", preUnit_id: "3", group: "0"},
						{unit_id: "12", preUnit_id: "11", group: "0"}])